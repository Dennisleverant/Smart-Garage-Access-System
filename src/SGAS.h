...
#include "BootstrapManager.h" // Must use the https://github.com/Dennisleverant/Arduino_Bootstrapper fork, SGAS branch
...
/********************************** PIN DEFINITIONS *****************************************/
#define INPUT_GD D2 // 
#define OUTPUT_GD D4 // red control terminal / GarageDoorOpener (UART1 TX) pin is D4 on D1 Mini
